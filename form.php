...
$q = "INSERT INTO `formq` (`firstname`, `surname`, `email`, `question`) VALUES ('$name', '$surname', '$email', '$message');";
...
<html>
    ...
    <h1 id="h1">Succesfully submited.</h1>

   
    <a href="index.html"> <button id="button" class="btn btn-info"><i class="fa fa-home"></i> Home</button> </a>
    </body>
</html>
